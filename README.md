...
This project helps to view json files in correct and readable form.
...
```#!bash
$ python pprint_json.py <file_name>
```

where <file_name> is path to file you want to view.
...
The code is written for educational purposes and make world better. Training course for web-developers - [DEVMAN.org](https://devman.org)
